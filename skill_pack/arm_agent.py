...
# Object/robot nouns come from the per-robot MANIFEST so the SAME agent drives
# either arm (ur5e.json -> "red ball"/"UR5e"; rebot.json -> "red cube"/"reBotArm
# B601-DM"). Tool *names* stay the same (get_ball_position etc.) — only the
# descriptions the LLM reads change.
OBJECT = cfg.s("object_noun", "red ball")
ROBOT = cfg.s("robot_name", "UR5e")
